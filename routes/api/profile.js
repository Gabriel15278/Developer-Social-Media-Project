...
router.post('/', [auth, [
        ...
        check('website', 'Valid URL required').optional().isURL(),
        check('location').optional().escape(),
        check('bio').optional().escape(),
        check('githubusername').optional().escape(),
        check('youtube', 'Valid URL required').optional().isURL(),
        check('twitter', 'Valid URL required').optional().isURL(),
        check('facebook', 'Valid URL required').optional().isURL(),
        check('linkedin', 'Valid URL required').optional().isURL(),
        check('instagram', 'Valid URL required').optional().isURL()
    ]
], async (req, res) => {
...
router.put('/education', [auth, [
    ...
    check('fieldofstudy', 'Field of study is required').not().isEmpty().escape(),
    check('from', 'From date is required').not().isEmpty()
]], async (req, res) => {
    const errors = validationResult(req);
    if(!errors.isEmpty()){
